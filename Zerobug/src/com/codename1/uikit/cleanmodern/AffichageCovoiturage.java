 ...
 * @author OrbitG
 */
public class AffichageCovoiturage extends BaseForm {

    ConnectionRequest con;
    Covoiturage c;

    public AffichageCovoiturage(Resources res) {
        ...
        RadioButton all = RadioButton.createToggle("Tous les trajets", barGroup);
...
//        bindButtonSelection(popular, arrow);
        ...
        con.setUrl("http://localhost/PIDEV/Entraide2.0/web/app_dev.php/mobile/all");
    ...
    Container c = new Container();
        ...
        Button Ajout = new Button("Proposer un trajet");
        c.add(Ajout);
